...
local panels = { 
  {name="1 Pot Target",hotkey="PageUp",mainFunction=potTarget,checkFunction=checkPot,createIcon=true,
  iconDetails={text="1 Pot", item = {id=3465,count=1}, switchable=false, hotkey=nil, movable=true}
  },
  {name="8 Pot Target",hotkey="Pause",mainFunction=fullPotTarget,checkFunction=checkFullPot,createIcon=true,
  iconDetails={text="8 Pot", item = {id=3465,count=5}, switchable=false, hotkey=nil, movable=true}
  },
  {name="Catar Pots",hotkey="PageDown",mainFunction=catarPots,checkFunction=contarPots,createIcon=true,
